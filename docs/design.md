...
**What the set covers.** Back, close, check, plus, menu, arrow-up; mic and lock for the voice note; sun and moon for night mode; and one per drawer section — ronda (¡Juguemos!), book (Hora del cuento), family, toy box, and sliders for Ajustes. Sliders rather than a gear, which reads mechanical.
