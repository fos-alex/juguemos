...
/**
 * @typedef {'activities' | 'lastActivityId' | 'timer' | 'activityChoices' | 'outside'} ActivitiesKey
 ...
 * decides. `outside` is the weather the next juego is picked for, as Home's corner shows it
 * (JUG-191).
 */
/**
