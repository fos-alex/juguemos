 ...
 * kid the story is for, and the second proposes something new (JUG-156); the
 ...
 *
 * "Contame qué cuento querés escuchar" opens the mic (JUG-156). What Ludi
  ...
  return (
    <Screen>
      ...
      <Body className="story-options">
        {/* A device that stored a screen of three before JUG-156 shows the first two. */}
