 ...
 * the way to talk (JUG-157). The words come back through `onText` for the
 * parent to check. `onMessage` says what went wrong, with a retry when the
 * note is still here to send again; the recording is held in memory only for
 * that.
 *
